  ...
  if (loading) {
    return (
      <div className="flex min-h-full items-center justify-center">
        <p className="text-sm text-white/40">Loading dream...</p>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-full items-center justify-center">
        <div className="text-center">
          <p className="text-sm text-white/40">Dream not found.</p>
          <button
    ...
    <div className="flex min-h-full items-center justify-center">
      <article className="w-full max-w-3xl">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 sm:p-10">
          ...
          {/* Inspired by */}
          {dream.inspired_by && dream.inspired_by.length > 0 && (
